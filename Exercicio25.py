#Exercicio: Conversão de Tipo com Validação
...
# da lista convertida é um inteiro. Se a conversão falhar ou um elemento não for um inteiro, imprima uma mensagem de erro. 
